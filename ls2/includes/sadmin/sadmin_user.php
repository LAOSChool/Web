	...
	<div class="widget blue" id='goparameter'>
		...
		<div class="widget-body" id="parameter">
			<script language="javascript">
				loadform('includes/sadmin/sadmin_user_form.php?lang=<?php echo $lang ?>','#parameter','#loadtext1');
			</script>
		</div>
	</div>
...
<script language="javascript">
	...
	$('#delbutton').live('click',function(){
		alert("Not now!");
		//if(confirm('Are you sure?')) loadform('includes/sadmin/sadmin_user_del.php?id='+$(this).attr('qid'),$(this).parent(),$(this).parent());
	});
	
	$('#editbutton').live('click',function(){
		loadform('includes/sadmin/sadmin_user_form.php?lang=<?php echo $lang ?>&type=edit&id='+$(this).attr('qid'),'#parameter','#loadform');
