<div class="span12">
	<div class="widget blue">
		...
		<div class="widget-body">
			<form method="POST" id='searchform' class="form-horizontal" action='includes/cdr/cdr_history_db.php?lang=<?php echo $lang ?>'>
				<div class="control-group">
					<label class="control-label">Phone number</label>
					<div class="controls">
						<input type="text" name="source_number" class="input-large" value=""/>
					</div>
				</div>
				
				<div class="control-group">
					<label class="control-label">CDR time</label>
	...
	<div class="widget green">
		...
		<div class="widget-body" id="entry">
			<script language="javascript">
				loadform('includes/cdr/cdr_history_db.php?lang=<?php echo $lang ?>','#entry','#loadtext');
			</script>
		</div>
	</div>
</div>
