...
<?php if($type=='search' || $type == ''): ?>
	...
	<form method=POST id='searchform' class="form-horizontal" action='includes/admin/admin_user_db.php?lang=<?php echo $lang ?>'>
...
<script language="javascript">
	...
	$('.formchange').click(function(){
		loadform('includes/admin/admin_user_form.php?lang=<?php echo $lang ?>&type='+$(this).attr('form'),'#parameter','#loadform');
	})
