...
<?php if($type=='search' || $type == ''): ?>
	...
	<form method=POST id='searchform' class="form-horizontal" action='includes/cls/cls_setclass_db.php'>
...
//////////////////////////////////////////////////////////////////////
	...
	$('.formchange').click(function(){
		loadform('includes/cls/cls_setclass_form.php?type='+$(this).attr('form'),'#parameter','#loadform');
	})
///////////////////////////////////////////////////////////////////////
