...
<?php if($type=='search' || $type == ''): ?>
	...
	<form method=POST id='searchform' class="form-horizontal" action='includes/usr/usr_manager_db.php'>
...
//////////////////////////////////////////////////////////////////////
	...
	$('.formchange').click(function(){
		loadform('includes/usr/usr_manager_form.php?type='+$(this).attr('form'),'#parameter','#loadform');
	})
///////////////////////////////////////////////////////////////////////
