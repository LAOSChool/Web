...
<script language="javascript">
	...
	$('#editbutton').live('click',function(){
		loadform('includes/usr/usr_manager_form.php?type=edit&id='+$(this).attr('qid')+'&table='+$(this).attr('qtable'),'#parameter','#loadform');
		$(document).scrollTo('#goparameter',1000, {offset:-61})
	});
	
	$('#passbutton').live('click',function(){
		loadform('includes/usr/usr_manager_form.php?type=changepass&id='+$(this).attr('qid')+'&table='+$(this).attr('qtable'),'#parameter','#loadform');
		$(document).scrollTo('#goparameter',1000, {offset:-61})
	});
