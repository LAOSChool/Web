...
<script language='javascript'>
	...
	$('.addchirld').click(function(){
		...
		loadform('includes/ivr/ivr_tree_form.php?type=add&parrent='+parrent,'#parameter','#loadtext1');
	});
	...
	$('.editchirld').click(function(){
		...
		$(this).addClass('selected');
		id = $(this).attr('qid');
		loadform('includes/ivr/ivr_tree_form.php?type=edit&id='+id,'#parameter','#loadtext1');
	});
