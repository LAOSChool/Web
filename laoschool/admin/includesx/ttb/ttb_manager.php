...
<script language="javascript">
	...
	$('#editbutton').live('click',function(){
		$('#listenmusic').html('');
		loadform('includes/ttb/ttb_manager_form.php?type=edit&id='+$(this).attr('qid')+'&table='+$(this).attr('qtable'),'#listenmusic','#listenload');
		$('#modalform').modal('show');
	});
	
	$('#addbutton').live('click',function(){
		//loadform('includes/ttb/ttb_manager_form.php?type=add&table='+$(this).attr('qtable'),'#parameter','#loadform');
		//$(window).scrollTo(0,0);
		$('#listenmusic').html('');
		loadform('includes/ttb/ttb_manager_form.php?type=add&table='+$(this).attr('qtable'),'#listenmusic','#listenload');
		$('#modalform').modal('show');
