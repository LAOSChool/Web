...
<?php if($type=='search' || $type == ''): ?>
	...
	<form method=POST id='searchform' class="form-horizontal" action='includes/mtb/mtb_scy_db.php'>
...
//////////////////////////////////////////////////////////////////////
	...
	$('.formchange').click(function(){
		loadform('includes/mtb/mtb_scy_form.php?type='+$(this).attr('form'),'#parameter','#loadform');
	})
///////////////////////////////////////////////////////////////////////
