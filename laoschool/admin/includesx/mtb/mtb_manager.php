	...
	<div class="widget blue" id='goparameter'>
		...
		<div class="widget-body" id="parameter">
			<script language="javascript">
				loadform('includes/mtb/mtb_manager_form.php','#parameter','#loadtext1');
			</script>
		</div>
	</div>
</div>
...
<div class="span6">
	<div class="widget green">
		...
		<div class="widget-body" id="entry">
			<script language="javascript">
				loadform('includes/mtb/mtb_manager_db.php','#entry','#loadtext');
			</script>
		</div>
	</div>
</div>
...
<script language="javascript">
	...
	$('#editbutton').live('click',function(){
		loadform('includes/mtb/mtb_manager_form.php?type=edit&id='+$(this).attr('qid')+'&table='+$(this).attr('qtable'),'#parameter','#loadform');
