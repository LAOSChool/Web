	...
	<div class="navbar navbar-static">
		<div class="navbar-inner">
			<div style="width: auto;" class="container">
				<a href="javascript:;" class="brand"><?php lang('rnkmanager') ?></a>
				<ul class="nav">
...
<?php if($type=='gen' || $type == ''): ?>

	<form method=POST  id='managerform' class="form-horizontal" action='includes/rnk/rnk_manager_gen.php?lang=<?php echo $lang ?>'>
				...
				<ul>
					<li>
						<label class="checkbox">
							<input type="checkbox" class='selectall' value='all' /> <b><?php lang('all') ?></b>
						</label>
						<ul>
							<?php
								$headers = array();
									...
									echo "<li><label class='parentlevel' qid='$lists->fval1'>
										...
										echo "<ul class='chirldlevel chirldlevel$lists->fval1'>";
											echo "<li><label class='checkbox'>
												<input type='checkbox' name='level' qid='$lists->fval1' id='level$lists->fval1' class='level'/> <b>$lang_all</b>
											</label></li>";
											foreach($clsdata->list as $lists2){
												if($lists2->level != $lists->fval1) continue;
												echo "<li><label class='checkbox'>
														<input name='class_id[]' type='checkbox' value='$lists2->id' class='class level$lists->fval1'/> $lists2->title
													</label></li>";
											}
										echo "</ul>";
									echo "</li>";
		...
		<div class="form-actions">
			<button type="submit" class="btn btn-info" name="submit"><i class="icon-refresh"></i> <?php lang('genrank') ?></button>
			<span id="submit"></span>
		</div>
...
//////////////////////////////////////////////////////////////////////
	...
	$('.formchange').click(function(){
		loadform('includes/rnk/rnk_manager_form.php?lang=<?php echo $lang ?>&type='+$(this).attr('form'),'#parameter','#loadform');
	})
///////////////////////////////////////////////////////////////////////
