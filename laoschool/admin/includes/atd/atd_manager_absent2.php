...
<form method=POST id='atdform' class="form-horizontal" action='includes/atd/atd_manager_send2.php'>
		<div class="control-group">
			<label class="control-label">$lang_content</label>
			<div class="controls">
				<textarea rows=4 name="message" class="input-xlarge"></textarea>
				<label class="checkbox">
					<input name="filter_roles[]" type="checkbox" value="STUDENT" /> $lang_sendsms
				</label>
				$stt
		...
		<div class="form-actions">
			<button type="submit" class="btn btn-info" name="submit"><i class="icon-location-arrow"></i> $lang_send</button>
