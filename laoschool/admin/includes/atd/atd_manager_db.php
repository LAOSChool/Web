...
$atddatas = explode("\n",$atdapi['output']);
$atddata = json_decode(end($atddatas));
...
<div class="dataTables_wrapper form-inline">
	<div class="row-fluid">
		<div class="span6">
			<div class="limit">
				<label>
					<a title='Absent' class='btn btn-medium btn-info' id='listenbutton2' href='javascript:void(0)'><i class='icon-play'></i> $lang_attendant</a>
				</label>
			</div>
		</div>
	</div>
...
<script language='javascript'>
	$('.changepage').click(function(){
		loadform('includes/atd/atd_manager_db.php?lang=$lang&$requestparam&page='+$(this).attr('page')+'&limit=$limit','#entry','#pageloadtext');
	});
	
	$("select[name=limit]").change(function() {
		loadform('includes/atd/atd_manager_db.php?lang=$lang&$requestparam&page=1&limit='+$(this).val(),'#entry','#limitloadtext')
	});
