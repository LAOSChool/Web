<div class="span12">
	<div class="widget blue">
		...
		<div class="widget-body">
			<form method="POST" id='searchform' class="form-horizontal" action='includes/weblog/weblog_history_db.php?lang=<?php echo $lang ?>'>
	...
	<div class="widget green">
		...
		<div class="widget-body" id="entry">
			<script language="javascript">
				loadform('includes/weblog/weblog_history_db.php?lang=<?php echo $lang ?>','#entry','#loadtext');
			</script>
		</div>
	</div>
</div>
