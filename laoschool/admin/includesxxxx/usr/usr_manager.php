...
<script language="javascript">
	...
	$('#delbutton').live('click',function(){
		if(confirm('Are you sure?')) loadform('includes/usr/usr_manager_del.php?id='+$(this).attr('qid'),$(this).parent(),$(this).parent());
	});
	...
	$('.exam_r').live('change',function(){
		...
		//alert(djson);
		loadform("includes/usr/usr_manager_send.php?djson="+djson,$(this));
	});
