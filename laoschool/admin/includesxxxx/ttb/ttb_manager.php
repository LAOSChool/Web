...
<script language="javascript">
	...
	$('#delbutton').live('click',function(){
		if(confirm('Are you sure?')) loadform('includes/ttb/ttb_manager_del.php?id='+$(this).attr('qid')+'&table='+$(this).attr('qtable'),$(this).parent(),$(this).parent());
	});
	...
	$('#listenbutton').live('click',function(){
		$('#listenmusic').html('');
		loadform('includes/ttb/ttb_manager_popmusic.php?id='+$(this).attr('qid'),'#listenmusic','#listenload');
		$('#modalform').modal('show');
	});
	...
	$('.exam_r').live('change',function(){
		...
		//alert(djson);
		loadform("includes/ttb/ttb_manager_send.php?djson="+djson,$(this));
	});
