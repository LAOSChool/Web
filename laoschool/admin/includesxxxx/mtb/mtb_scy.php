...
<script language="javascript">
	...
	$('#delbutton').live('click',function(){
		if(confirm('Are you sure?')) loadform('includes/mtb/mtb_scy_del.php?id='+$(this).attr('qid'),$(this).parent(),$(this).parent());
	});
	...
	$('#listenbutton').live('click',function(){
		$('#listenmusic').html('');
		loadform('includes/mtb/mtb_scy_popmusic.php?id='+$(this).attr('qid'),'#listenmusic','#listenload');
	...
	$('.exam_r').live('change',function(){
		...
		//alert(djson);
		loadform("includes/mtb/mtb_scy_send.php?djson="+djson,$(this));
	});
