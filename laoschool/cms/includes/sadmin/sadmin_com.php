	...
	<div class="widget blue" id='goparameter'>
		...
		<div class="widget-body" id="parameter">
			<script language="javascript">
				loadform('includes/sadmin/sadmin_com_form.php','#parameter','#loadtext1');
			</script>
		</div>
	</div>
	<div class="widget green">
		<div class="widget-title">
			<h4><i class="<?php echo $currenticon; ?>"></i> <?php echo $currentsubtab ?></h4>
			<span class="tools">
...
<script language="javascript">
	...
	$('#delbutton').live('click',function(){
		alert("Not now!");
		//if(confirm('Are you sure?')) loadform('includes/sadmin/sadmin_com_del.php?id='+$(this).attr('qid'),$(this).parent(),$(this).parent());
	});
	
	$('#editbutton').live('click',function(){
		loadform('includes/sadmin/sadmin_com_form.php?type=edit&id='+$(this).attr('qid'),'#parameter','#loadform');
