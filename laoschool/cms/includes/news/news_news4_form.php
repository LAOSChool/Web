...
<?php
	...
	?>
	<form method=POST id='managerform' class="form-horizontal" action='includes/news/news_news4_edit.php'>
...
//////////////////////////////////////////////////////////////////////
	...
	$('.formchange').click(function(){
		loadform('includes/news/news_news4_form.php?type='+$(this).attr('form'),'#parameter','#loadform');
	})
///////////////////////////////////////////////////////////////////////
