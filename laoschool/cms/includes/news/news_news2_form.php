	...
	<div class="navbar navbar-static">
		<div class="navbar-inner">
			<div style="width: auto;" class="container">
				<a href="javascript:;" class="brand">Quản lý ý kiến phụ huynh</a>
				<ul class="nav">
					<li <?php echo ($type=='add')?"class='active'":"" ?>><a href="javascript:;" class='formchange' form="add"><i class="icon-plus"></i> Thêm ý kiến</a></li>
...
<?php if($type=='edit'): ?>
	...
	?>
	<form method=POST id='managerform' class="form-horizontal" action='includes/news/news_news2_edit.php'>
...
<?php elseif($type=='add'): ?>
	<form method=POST id='managerform' class="form-horizontal" action='includes/news/news_news2_add.php'>
		...
		<div class="form-actions">
			<button type="submit" class="btn btn-info" name="submit"><i class="icon-plus"></i> Thêm</button>
			<span id="submit"></span>
		</div>
	</form>
<?php else: ?>
	Bấm ở dưới để sửa, hoặc thêm ở trên.
<?php endif; ?>
...
//////////////////////////////////////////////////////////////////////
	...
	$('.formchange').click(function(){
		loadform('includes/news/news_news2_form.php?type='+$(this).attr('form'),'#parameter','#loadform');
	})
///////////////////////////////////////////////////////////////////////
