	...
	<div class="widget blue" id='goparameter'>
		...
		<div class="widget-body" id="parameter">
			<script language="javascript">
				loadform('includes/news/news_news2_form.php','#parameter','#loadtext1');
			</script>
		</div>
	</div>
...
<script language="javascript">
	...
	$('#delbutton').live('click',function(){
		if(confirm('Are you sure?')) loadform('includes/news/news_news2_del.php?id='+$(this).attr('qid'),$(this).parent(),$(this).parent());
	});
	
	$('#editbutton').live('click',function(){
		$(document).scrollTo('#goparameter',1000, {offset:-61})
		loadform('includes/news/news_news2_form.php?type=edit&id='+$(this).attr('qid'),'#parameter','#loadform');
	});
